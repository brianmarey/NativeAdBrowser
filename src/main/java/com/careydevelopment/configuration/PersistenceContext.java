...
@EnableJpaRepositories(basePackages = {
        "com.careydevelopment.nativeadbrowser.jpa"
})
@EnableTransactionManagement
class PersistenceContext {
	   private static final String PROPS_FILE = "/etc/tomcat8/resources/nativeadmysql.properties";
	   ...
	   public DriverManagerDataSource dataSource() {
	    ...
	    LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource dataSource) {
	        ...
	        entityManagerFactoryBean.setPackagesToScan("com.careydevelopment.nativeadbrowser.jpa.entity");
